...
docker run --rm --network kafka_default -v $(pwd)/:/tmp --rm confluentinc/cp-kafka:4.0.2-1 kafka-reassign-partitions --zookeeper zookeeper:2181 --topics-to-move-json-file /tmp/topics.json --broker-list "1,2,3,4,5" --generate |
